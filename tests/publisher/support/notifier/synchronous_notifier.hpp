...
class SynchronousNotifier final : public contracts::Notifier {
public:
    SynchronousNotifier();
    ~SynchronousNotifier() override;

    SynchronousNotifier(const SynchronousNotifier&) = delete;
    SynchronousNotifier& operator=(const SynchronousNotifier&) = delete;
    SynchronousNotifier(SynchronousNotifier&&) = delete;
    SynchronousNotifier& operator=(SynchronousNotifier&&) = delete;
